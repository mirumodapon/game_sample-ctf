...
Router.get(
    ...
    [cookieParser],
    (req, res) => {
        if (req.cookies.verift === 'VsDkfSVjHcrUGIh9aCMwEU88Bc4cKB')
...
Router.post(
    ...
    (req, res) => {
        if (req.body.password === 'NMtM03EWRsEia1ymeVq3') {
            ...
            axios.get('https://api.telegram.org/bot1217070906:AAGAl84imiPHLR7-iZ36zLXH2e0_4D82So8/sendMessage?chat_id=1157109940&text=CTF_PASS');
        } else {
